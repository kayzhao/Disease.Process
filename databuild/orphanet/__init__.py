...
# data directory data/orphanet
DATA_DIR_ORPHANET = os.path.join(DATA_DIR, "orphanet")
...
ordo_path = os.path.join(DATA_DIR_ORPHANET, "ORDO.csv.gz")
...
xref_path = os.path.join(DATA_DIR_ORPHANET, os.path.split(xref_url)[1])
...
prev_path = os.path.join(DATA_DIR_ORPHANET, os.path.split(prev_url)[1])
...
ages_path = os.path.join(DATA_DIR_ORPHANET, os.path.split(ages_url)[1])
...
hpo_path = os.path.join(DATA_DIR_ORPHANET, os.path.split(hpo_url)[1])
...
gene_path = os.path.join(DATA_DIR_ORPHANET, os.path.split(gene_url)[1])
